...
public class PaymentController {
    ...
    public List<PaymentDetails> getByCustomerId(@RequestParam(value = "customerId") int customerId,
    ...
    public List<PaymentDetails> getByAccountNumber(@RequestParam(value = "accountNumber") String accountNumber,
                                                     @RequestParam(defaultValue = "0") int page,
                                                     @RequestParam(defaultValue = "5") int size){
        Pageable pageable = PageRequest.of(page, size);
